	...
	case "sendsms":
		...
		$tpl = array(
			...
			'vars' => array(
				...
				'Send to' => _('Send to'),
				'Message' => _('Message'),
                'Message variable' => _('＃NAME＃ will be replaced with the name listed in phonebook,＃NUM＃ will be replaced with the phone number listed in phonebook'),//add
                ...
                'HINT_MESSAGE' => _hint(_('SMS content is recommended to control within 200 (some telecom operators will intercept content), more than 70 words by 67 words a text message billing')),
                'HINT_SENDER_ID' => _hint(_('Only a few countries')),//add
				'HINT_SEND_TO' => _('Prefix with # for groups and @ for users'),//add
