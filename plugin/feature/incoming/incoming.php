...
switch (_OP_) {
	case "incoming":
		...
		$select_match_username = _yesno('incoming_match_username', $pre_rules['match_username'], '', '', '', 'sms-incoming-match-username', 'form-control');
		
		// scan message for #groupcode
		$select_match_groupcode = _yesno('incoming_match_groupcode', $pre_rules['match_groupcode'], '', '', '', 'sms-incoming-match-groupcode', 'form-control');
		
		$form_pre_rules = array(
			array(
				'id' => 'sms-incoming-match-username',
			...
			array(
				'id' => 'sms-incoming-match-groupcode',
		...
		$select_match_sender_id = _yesno('sandbox_match_sender_id', $post_rules['match_sender_id'], '', '', '', 'sms-sandbox-match-sender-id', 'form-control');
		...
		$input_prefix = _input('text', 'sandbox_prefix', $post_rules['insert_prefix'], $params, 'sms-sandbox-prefix', 'form-control');
		...
		$select_users = themes_select_users_multi('uids', $post_rules['forward_to'], $params, 'sms-route-to-users');
		...
		$input_url = _input('text', 'forward_to_url', $post_rules['forward_to_url'], $params, 'sms-forward-to-url', 'form-control');
		
		$form_post_rules = array(
			array(
				'id' => 'sms-sandbox-match-sender-id',
